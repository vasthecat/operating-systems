...
def test_st_iter_length1_first():
    ...
    result = run(f"./brute -m -y -l 1 -h {hashed} -a abc")
...
def test_st_iter_length2_first():
    ...
    result = run(f"./brute -m -y -l 2 -h {hashed} -a abc")
...
def test_st_iter_length3_first():
    ...
    result = run(f"./brute -m -y -l 3 -h {hashed} -a abc")
...
def test_st_iter_length7_first():
    ...
    result = run(f"./brute -m -y -l 7 -h {hashed} -a abc")
