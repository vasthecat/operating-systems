...
# Length 2
def test_mt_rec_length2_first():
    base_call_found("aa")

def test_mt_rec_length2():
    base_call_found("bc")

def test_mt_rec_length2_last():
    base_call_found("cc")

def test_mt_rec_length2_notfound():
    base_call_notfound("qa")

# Length 3
def test_mt_rec_length3_first():
    base_call_found("aaa")

def test_mt_rec_length3():
    base_call_found("bac")

def test_mt_rec_length3_last():
    base_call_found("ccc")

def test_mt_rec_length3_notfound():
